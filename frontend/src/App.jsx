  ...
  return (
    <div className="">
      <Routes>
        ...
        {/* <Route path="/desa" element={<div>Detail Desa</div>} />
        <Route path="/penduduk" element={<div>Detail Penduduk</div>} />
        <Route path="/keluarga" element={<div>Detail Keluarga</div>} />
        <Route path="/sekolah" element={<div>Detail Sekolah</div>} />
        <Route path="/kesehatan" element={<div>Detail Kesehatan</div>} /> */}
      </Routes>
    </div>
  );
}
